...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0">Laporan Harian Lainnya</h4>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="" action="<?= site_url('laporan/lain/save');?>" method="post" id="addform" enctype="multipart/form-data">
                <div class="mb-3 row">
                  <label for="example-text-input" class="col-md-4 col-form-label">Nama Kegiatan</label>
                  <div class="col-md-8">
...
var laporanTable = $('#laporan').DataTable({
      ...
      serverSide: true,
      ajax: {
          url: '<?= site_url('laporan/lain/getdata')?>',
          method: 'POST',
          data: function (d) {
                d.tahun = $('#tahun').val();
                d.bulan = $('#bulan').val();
